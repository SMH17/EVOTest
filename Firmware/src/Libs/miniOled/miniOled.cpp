/*
V 0.4.0  miniOled.cpp modified by Silvio Marano to support different SSD1306 (rather than just 0.96")
a different font support has been included as well.

A VERY BASIC oled SSD1306 library, compatible with SoftWire I2C library.
...
#ifdef SOFTWIRE
	#include <SoftWire.h>
	SoftWire Wire(PA10, PA9);  // default gpio (SoftWire needs a default)
#else
	#include <Wire.h>
#endif
/*
static const byte OLED64X48[] = {0xae,0xa6,0xAE,0xD5,0x80,0xA8,0x2F,0xD3,
		0x0,0x40 | 0x0,0x8D,0x14,0x20,0x00,      
        0xA0 | 0x1,0xC8,0xDA,0x12,0x81,0xCF,
        0xd9,0xF1,0xDB,0x40,0xA4,0xA6,0x2e,0x20,0x00};

static const byte OLED96X96[] = {0xae,0xa6,0xAE,0xD5,0x80,0xA8,0x0F,0xD3,
		0x0,0x40 | 0x0,0x8D,0x14,0x20,0x00,      
        0xA0 | 0x1,0xC8,0xDA,0x02,0x81,0xCF,
        0xd9,0xF1,0xDB,0x40,0xA4,0xA6,0x2e,0x20,0x00};

static const byte OLED128X32[] = {0xae,0xa6,0xAE,0xD5,0x80,0xA8,0x1F,0xD3,
		0x0,0x40 | 0x0,0x8D,0x14,0x20,0x00,      
        0xA0 | 0x1,0xC8,0xDA,0x02,0x81,0xCF,
        0xd9,0xF1,0xDB,0x40,0xA4,0xA6,0x2e,0x20,0x00};
		
static const byte OLED128X64[] = {0xae,0xa6,0xAE,0xD5,0x80,0xA8,0x3F,0xD3,
		0x0,0x40 | 0x0,0x8D,0x14,0x20,0x00,      
        0xA0 | 0x1,0xC8,0xDA,0x12,0x81,0xCF,
        0xd9,0xF1,0xDB,0x40,0xA4,0xA6,0x2e,0x20,0x00};
*/
static const byte displayInitConf[] = {0xae,0xa6,0xAE,0xD5,0x80,0xA8,0x1F,0xD3,  //OLED128X32 replace with needed config
		0x0,0x40 | 0x0,0x8D,0x14,0x20,0x00,      
        0xA0 | 0x1,0xC8,0xDA,0x02,0x81,0xCF,
        0xd9,0xF1,0xDB,0x40,0xA4,0xA6,0x2e,0x20,0x00};
...
const byte smallerFont[][5]  = {   // 5x8 in a 6x8 space.
