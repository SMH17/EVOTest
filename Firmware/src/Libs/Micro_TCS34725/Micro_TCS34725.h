...
#ifndef _Micro_TCS34725_H_
#define _Micro_TCS34725_H_
#include <Arduino.h>
#include <SoftWire.h>
...
class Micro_TCS34725 
{
  public:
	Micro_TCS34725(uint8_t I2C_addr = TCS34725_ADDRESS, eIntegrationTime_t = TCS34725_INTEGRATIONTIME_2_4MS, eGain_t = TCS34725_GAIN_1X);
	/**
	 * @fn begin
